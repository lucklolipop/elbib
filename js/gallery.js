			...
			_showImage		= function( $item ) {
				...
				var $thumb		= $item.find('img'),
					largesrc	= $thumb.data('large'),
                                        view		= $thumb.data('view'),
                                        like		= $thumb.data('like'),
				...
				$('<img/>').load( function() {
					...
					if( title )
						$rgGallery.find('div.rg-caption').show().children('p').empty().text( title );
                                        if( like )
						$rgGallery.find('div.rg-caption-like').show().children('a').empty().text( like );
                                        if( view )
						$rgGallery.find('div.rg-caption-view').show().children('a').empty().text( view );
